...
entity my_filter is
	...
	port (
	   ...
	   filter_in_data		: in STD_LOGIC_VECTOR(G_DATA_WIDTH-1 downto 0);	
	
		--Data Output
	   filter_out_vld		: out STD_LOGIC;
	   filter_out_data		: out STD_LOGIC_VECTOR(G_DATA_WIDTH-1 downto 0)
	);
end my_filter;
...
architecture RTL of my_filter is
    ...
    signal fir_out_data : std_logic_vector (G_DATA_WIDTH-1 downto 0);

    -- signals for pipeline
    signal pipe_out_vld : std_logic;
    signal pipe_out_data : std_logic_vector (G_DATA_WIDTH-1 downto 0);    
